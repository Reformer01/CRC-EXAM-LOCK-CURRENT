# CRC Exam Lockdown — Chrome Extension

Exam proctoring extension for CRC school. Locks down Google Forms during exams with a fixed 2-hour timer and reports all activity to Google Sheets.
...
1. Create a new **Google Spreadsheet** (name it e.g. "CRC Exam Log")
...
4. Select the `CRC-EXAM-LOCK` folder
